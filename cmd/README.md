...
```bash
wget https://github.com/viant/bqtail/releases/download/v2.9.0/bqtail_osx_2.8.0.tar.gz
...
```bash
wget https://github.com/viant/bqtail/releases/download/v2.9.0/bqtail_linux_2.8.0.tar.gz
