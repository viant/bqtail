...
```bash
wget https://github.com/viant/bqtail/releases/download/v2.2.0/bqtail_osx_2.2.0.tar.gz
tar -xvzf bqtail_osx_2.2.0.tar.gz
...
```bash
wget https://github.com/viant/bqtail/releases/download/v2.2.0/bqtail_linux_2.2.0.tar.gz
tar -xvzf bqtail_linux_2.2.0.tar.gz
cp bqtail /usr/local/bin/
```
