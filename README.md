...
Having a dedicated project only for loading data, allowed us to identify intermittent loading capacity reduction on default-pipeline, with BqTail monitor 
