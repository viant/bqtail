...
In some cases, we've seen delays up to a few hours from a few min baseline load completion time. BqTail addresses loading capacity issue by either using a transient BigQuery project with slot reservation, or by load balancing
